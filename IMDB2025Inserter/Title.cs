...
namespace IMDB2025Inserter {
    public class Title {
        ...
        public Title(int? Id, int TypeId, string PrimaryTitle, string? OriginalTitle, bool IsAdult,int? StartYear, int? EndYear,int? RuntimeMinutes, List<string>? Genres) {
            this.Id = Id;
            this.TypeId = TypeId;
        ...
        // public Title() :this(null,0,"",null,false,null,null,null){
        // }
